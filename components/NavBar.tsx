	...
	return (
		<header className="bg-background/50  border-b  sticky top-0 backdrop-blur  z-30 scroll-p-16 scroll-smooth">
			<div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
					...
					<div className="md:flex md:items-center md:gap-12">
						<nav aria-label="Global" className="hidden md:block">
							<ul className="flex items-center gap-6 text-sm font-medium">
								<li>
									<Link href="/"
										className={pathname === "/" ? "transition duration-300 ease-in-out text-red-600 underline underline-offset-4 hover:scale-105" : "transition duration-300 ease-in-out hover:text-red-600 hover:underline hover:underline-offset-4 hover:scale-105"}
										>
										Home
									</Link>
								</li>
								<li>
									<Link
										className={pathname === "/about" ? "transition duration-300 ease-in-out text-red-600 underline underline-offset-4 hover:scale-105" : "transition duration-300 ease-in-out hover:text-red-600 hover:underline hover:underline-offset-4 hover:scale-105"}
										href="/about">
										About
									</Link>
								</li>
								<li>
									<Link
										className={pathname === "/shop" ? "transition duration-300 ease-in-out text-red-600 underline underline-offset-4 hover:scale-105" : "transition duration-300 ease-in-out hover:text-red-600 hover:underline hover:underline-offset-4 hover:scale-105"}
										href="/shop">
										Shop
									</Link>
								</li>
                <li>
									<Link
										className={pathname === "/designers" ? "transition duration-300 ease-in-out text-red-600 underline underline-offset-4 hover:scale-105" : "transition duration-300 ease-in-out hover:text-red-600 hover:underline hover:underline-offset-4 hover:scale-105"}
										href="/designers">
										Designer
									</Link>
								</li>
                ...
                <>
                  <li>
                    <Link href="/login" className={pathname === "/login" ? "text-red-600" : "hover:text-red-600"}>
                      Login
                    </Link>
                  </li>
                  <li>
                    <Link href="/register" className={pathname === "/register" ? "text-red-600" : "hover:text-red-600"}>
                      Register
                    </Link>
                  </li>
                </>
								...
								{isSheetVisible && (
									<Sheet>
										...
										<SheetContent className="overflow-auto max-h-screen p-4">
											<SheetHeader>
												<SheetTitle>							<img src="/images/logo.png" alt="semo home" />
                        </SheetTitle>
